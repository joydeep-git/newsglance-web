...
import { useInfiniteCategoryNews } from "@/hooks/newsHooks";
...
const CategoryLayout = ({ category }: { category: keyof typeof newsCategories }) => {


  const { data, isLoading, isError, isFetchingNextPage, hasNextPage, fetchNextPage } = useInfiniteCategoryNews(category);


  const displayName = newsCategories[category];
